    ...
    <Box>
      <Box className={classes.header}>
        <Box className={classes.center}>
          <a href='https://github.com/karlosos'>
            <Avatar className={classes.avatar} alt='Karol Dzialowski' src='https://secure.gravatar.com/avatar/5721fbdfcafc3269ac39d9f98c6eba02' />
          </a>
        </Box>
        <Box className={classes.center}>
      ...
      <Grid className={classes.content} container spacing={3}>
        <Grid item md={4}>
          <Paper className={classes.paper}>
            ...
            <Button className={classes.button} href='https://github.com/karlosos'>
              <GitHubIcon className={classes.icon} />
              <span>Check me on GitHub</span>
            </Button>

            <Button className={classes.button} href='https://www.linkedin.com/in/karol-dzialowski/'>
